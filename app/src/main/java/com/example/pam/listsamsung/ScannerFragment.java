...
public class ScannerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnHome = (Button) view.findViewById(R.id.buttonScanner);
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Scanner Button Click", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            Toast.makeText(context, "Scanner Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
